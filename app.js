...
an interface between two applications allow interactions between them without the use of less abstract language
    - two types of API's
        -browser API
        built into the browser and able to expose data from browser and environment, ex: DOM APIO allowing us to style page, make popup windows appear, etc.
        - third party API's
...
defined set of request methods which indicate an action to be performed
    REST - representational state transfer architectural style for stateless standard of communication; rest requires HTTP
